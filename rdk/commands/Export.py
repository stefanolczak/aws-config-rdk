...
import shutil
from rdk import ROOT_DIR, RULES_DIR
from rdk.Util import Util


def export(args):

    args = get_export_parser().parse_args(args.command_args, args)
    ...
    # get the rule names
    rule_names = Util.get_rule_list_for_command(args, "export")
    ...
    for rule_name in rule_names:
        ...
        subnet_ids = []
        security_group_ids = []
        if args.lambda_security_groups:
            security_group_ids = args.lambda_security_groups.split(",")

        if args.lambda_subnets:
            subnet_ids = args.lambda_subnets.split(",")
        ...
        my_params = {
            ...
            "lambda_timeout": str(args.lambda_timeout),
        }
        ...
        print(args.format + " version: " + args.version)
